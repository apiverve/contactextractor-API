# Contact Extractor API - Examples

This folder contains example code for using the Contact Extractor API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/contactextractor',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/contactextractor");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/contactextractor](https://docs.apiverve.com/ref/contactextractor)
