...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/contactextractor',
        'Source': 'https://github.com/apiverve/contactextractor-api',
        'Bug Tracker': 'https://github.com/apiverve/contactextractor-api/issues'
    },
    classifiers=[
