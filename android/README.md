...
```gradle
dependencies {
    implementation 'com.github.apiverve:contactextractor-api:1.1.12'
}
```
...
```java
import com.apiverve.contactextractor.ContactExtractorAPIClient;
import com.apiverve.contactextractor.APIResponse;
import com.apiverve.contactextractor.APIException;

// Initialize the client
ContactExtractorAPIClient client = new ContactExtractorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/contactextractor](https://docs.apiverve.com/ref/contactextractor)
...
- **Documentation:** [https://docs.apiverve.com/ref/contactextractor](https://docs.apiverve.com/ref/contactextractor)
- **Issues:** [GitHub Issues](https://github.com/apiverve/contactextractor-api/issues)
